    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('barang/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
...
<?php endif ?>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' '; 
				echo anchor(site_url('barang/update/'.$barang->id_barang),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
